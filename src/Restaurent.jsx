            ...
            <div className="book">
                ...
                <div className="flip-book">
                    <div className="flip" id="p1">
                        ...
                        <div className="front">
                            <h2 className="h2Rest title text-[15px] tracking-[6px] font-primary text-[50px]">Pizza</h2>
                    ...
                    <div className="flip" id="p2">
                        ...
                        <div className="front">
                            <h2 className="h2Rest title text-[15px] tracking-[6px] font-primary text-[50px]">couscous tunisien</h2>
                    ...
                    <div className="flip" id="p3">
                        ...
                        <div className="front">
                            <h2 className="h2Rest title text-[15px] tracking-[6px] font-primary text-[50px]">Magret de canard</h2>
