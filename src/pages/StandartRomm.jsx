  ...
  return (
    <div>
      <div className="sectionone">
        <img className="imsectionone" src="standart.jpg" alt="Room"></img>
      </div>
      <Alert/>
      <div className="sectiontow">
        <div className="roomDetails">
          <h3 className="info-title font-primary "> Chambre Standart</h3>
        ...
        <div className="">
          <img className="imageroomdt" src="standart.jpg" alt="Room"></img>
        </div>
      </div>
