  ...
  return (
    <div>
      <div className="sectionone">
        <img className="imsectionone" src="MainRoom.jpg" alt="Room"></img>
      </div>
      <Alert/>
      <div className="sectiontow">
    
        <div className="roomDetails">
          <h3 className="info-title font-primary "> Chambre Superieur</h3>
          
        
          <p className="roominfo">Max People: 2 </p>
        ...
        <div className="">
          <img className="imageroomdt" src="MainRoom.jpg" alt="Room"></img>
        </div>
      </div>
